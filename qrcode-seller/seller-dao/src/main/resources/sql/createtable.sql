...
CREATE TABLE IF NOT EXISTS `QRCODE`.`TB_PQ_CATEGORYGROUP` (
...
CREATE TABLE IF NOT EXISTS `QRCODE`.`TB_PQ_CATEGORYATTR` (
...
CREATE TABLE IF NOT EXISTS `QRCODE`.`TB_PQ_PRODUCT` (
...
CREATE TABLE IF NOT EXISTS `QRCODE`.`TB_PQ_PRTEXTATTR` (
